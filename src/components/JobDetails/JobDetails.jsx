...
const JobDetails = () => {
    ...
    return (
        <div>
            ...
            <div className="grid gap-4 md:grid-cols-4 p-8">
                ...
                <div className="md:col-span-1 bg-gradient-to-tr from-blue-100 to-purple-100 rounded-lg p-3">
                    ...
                    <div className="flex justify-center space-x-1 mt-7">
                        <h2 className="text-xl"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M21.75 6.75V17.25C21.75 17.8467 21.5129 18.419 21.091 18.841C20.669 19.2629 20.0967 19.5 19.5 19.5H4.5C3.90326 19.5 3.33097 19.2629 2.90901 18.841C2.48705 18.419 2.25 17.8467 2.25 17.25V6.75M21.75 6.75C21.75 6.15326 21.5129 5.58097 21.091 5.15901C20.669 4.73705 20.0967 4.5 19.5 4.5H4.5C3.90326 4.5 3.33097 4.73705 2.90901 5.15901C2.48705 5.58097 2.25 6.15326 2.25 6.75M21.75 6.75V6.993C21.75 7.37715 21.6517 7.75491 21.4644 8.0903C21.2771 8.42569 21.0071 8.70754 20.68 8.909L13.18 13.524C12.8252 13.7425 12.4167 13.8582 12 13.8582C11.5833 13.8582 11.1748 13.7425 10.82 13.524L3.32 8.91C2.99292 8.70854 2.72287 8.42669 2.53557 8.0913C2.34827 7.75591 2.24996 7.37815 2.25 6.994V6.75" stroke="url(#paint0_linear_7_463)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <defs>
                    ...
                    <div className="flex justify-center space-x-2 mt-7">
                        <h2 className="text-xl"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                            <path d="M15 10.5C15 11.2956 14.6839 12.0587 14.1213 12.6213C13.5587 13.1839 12.7956 13.5 12 13.5C11.2044 13.5 10.4413 13.1839 9.87868 12.6213C9.31607 12.0587 9 11.2956 9 10.5C9 9.70435 9.31607 8.94129 9.87868 8.37868C10.4413 7.81607 11.2044 7.5 12 7.5C12.7956 7.5 13.5587 7.81607 14.1213 8.37868C14.6839 8.94129 15 9.70435 15 10.5Z" stroke="url(#paint0_linear_7_460)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <path d="M19.5 10.5C19.5 17.642 12 21.75 12 21.75C12 21.75 4.5 17.642 4.5 10.5C4.5 8.51088 5.29018 6.60322 6.6967 5.1967C8.10322 3.79018 10.0109 3 12 3C13.9891 3 15.8968 3.79018 17.3033 5.1967C18.7098 6.60322 19.5 8.51088 19.5 10.5Z" stroke="url(#paint1_linear_7_460)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            <defs>
            ...
            <div className="-mt-6 mb-32 md:mr-5
            sm:mr-12 
            flex justify-end items-center">
                <button onClick={handleApplyNow} className="btn btn-primary capitalize bg-gradient-to-r from-[#7E90FE] to-[#9873FF] border-none text-white text-lg px-8 py-2 md:w-3/12 sm:w-11/12">Apply Now</button>
            </div>
            <ToastContainer />
        </div>
    );
